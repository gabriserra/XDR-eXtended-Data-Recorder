...
noise_subtrip = filler(kicks15);
noise_subtrip2=filler(urto154);
noise_subtrip3=filler(kicks);
noise_subtrip4=filler(turn_norm);
noise_subtrip5 = filler(longtrip2);
noise_subtrip6 = filler(longtrip16);
...
%plot(var(:,3),'r')
[suddens, turns, static_crashes, dynamic_crashes,zz]=main_checker(var,n_var);
zsuddens=suddens; 
zturns=turns;
